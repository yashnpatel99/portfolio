...
function App() {
  ...
  useEffect(() => {
    ...
    const hoverElements = document.querySelectorAll('a, button, .project-item, .skill-item, .exp-card');
    const onMouseEnter = () => {
      if (follower) {
  ...
  useEffect(() => {
    ...
    document.querySelectorAll('.reveal, .skill-item, .count-up').forEach(el => io.observe(el));
    ...
    <>
      ...
      <section id="home">
        ...
        <h1 className="hero-name">
          ...
          <span className="line"><span><span className="accent-word glitch" data-text="PATEL">PATEL</span></span></span>
        </h1>

        <div className="hero-sub">
          <p className="hero-desc">Crafting pixel-perfect, high-performance React applications. I turn ideas into exceptional digital experiences with modern web tools.</p>
          <div className="hero-cta">
            <a href="#projects" className="btn-primary">View Work &darr;</a>
            <a href="#contact" className="btn-outline">Let's Talk &rarr;</a>
          </div>
        </div>
      ...
      <section id="about">
        <div>
          ...
          <h2 className="section-title reveal reveal-delay-1">Building the <br /><em style={{ fontStyle: 'italic', color: 'var(--accent)' }}>web of</em><br />tomorrow</h2>
          <p className="about-text reveal reveal-delay-2">
            I'm a passionate React.js Developer with experience building dynamic, responsive, and scalable web applications. I prioritise component architecture, performance improvement, and amazing user experiences.
          </p>
          <p className="about-text reveal reveal-delay-3">
            Skilled in integrating Figma designs into functioning interfaces, I possess hands-on expertise building modular architectures with modern frontend tools like React and Next.js.
          </p>
        </div>
        ...
        <div className="about-right">
          ...
          <div className="stats-grid reveal reveal-delay-1">
            <div className="stat-item">
              <span className="stat-number count-up" data-target="7">0</span>
              <span className="stat-label">Projects Shipped</span>
            </div>
            <div className="stat-item">
              <span className="stat-number count-up" data-target="2">0</span>
              <span className="stat-label">Years Experience</span>
            </div>
            <div className="stat-item">
              <span className="stat-number count-up" data-target="9">0</span>
              <span className="stat-label">Skills Mastered</span>
            </div>
            <div className="stat-item">
              <span className="stat-number count-up" data-target="100">0</span>
      ...
      <section id="skills">
        <div className="skills-header">
          <div>
            ...
            <h2 className="section-title reveal reveal-delay-1">My<br />Arsenal</h2>
          </div>
        </div>
        ...
        <div className="skills-grid">
          <div className="skill-item reveal">
            ...
            <div className="skill-info">
              ...
              <div className="skill-bar-wrapper"><div className="skill-bar" style={{ width: '95%' }}></div></div>
            </div>
          </div>
          <div className="skill-item reveal reveal-delay-1">
            ...
            <div className="skill-info">
              ...
              <div className="skill-bar-wrapper"><div className="skill-bar" style={{ width: '90%' }}></div></div>
            </div>
          </div>
          <div className="skill-item reveal reveal-delay-2">
            ...
            <div className="skill-info">
              ...
              <div className="skill-bar-wrapper"><div className="skill-bar" style={{ width: '92%' }}></div></div>
            </div>
          </div>
          <div className="skill-item reveal">
            <span className="skill-icon">⚙️</span>
            <div className="skill-info">
              ...
              <div className="skill-bar-wrapper"><div className="skill-bar" style={{ width: '85%' }}></div></div>
            </div>
          </div>
          <div className="skill-item reveal reveal-delay-1">
            <span className="skill-icon">🎨</span>
            <div className="skill-info">
              ...
              <div className="skill-bar-wrapper"><div className="skill-bar" style={{ width: '88%' }}></div></div>
            </div>
          </div>
          <div className="skill-item reveal reveal-delay-2">
            <span className="skill-icon">🟠</span>
            <div className="skill-info">
              ...
              <div className="skill-bar-wrapper"><div className="skill-bar" style={{ width: '98%' }}></div></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="projects">
        ...
        <div className="projects-list">
          <div className="project-item reveal">
            ...
            <span className="project-desc">A dynamic, content-driven web application for a credit card company, featuring loan details, calculators, and Strapi CMS integration.</span>
          ...
          <div className="project-item reveal">
            ...
            <span className="project-desc">A modern informational website designed to showcase company details and services, powered by Strapi CMS for flexible content.</span>
            <span className="project-tag">Corporate</span>
          </div>
          <div className="project-item reveal">
            <span className="project-num">03</span>
            <span className="project-title">Key-Star</span>
            <span className="project-desc">A feature-rich educational platform providing online learning resources, course listings, and dynamic content management.</span>
            <span className="project-tag">EdTech</span>
          </div>
          <div className="project-item reveal">
            <span className="project-num">04</span>
            <span className="project-title">Design Invite</span>
            <span className="project-desc">An e-commerce platform for digital and print-ready invitation cards, featuring integrated Razorpay checkout and video editing services.</span>
            <span className="project-tag">E-Commerce</span>
          </div>
          <div className="project-item reveal">
            <span className="project-num">05</span>
            <span className="project-title">OPM Events</span>
            <span className="project-desc">Hotel and resort booking website built for event management, allowing users to explore venues, check availability, and make booking inquiries easily.</span>
            <span className="project-tag">Booking</span>
          </div>
          <div className="project-item reveal">
            <span className="project-num">06</span>
            <span className="project-title">BizApp</span>
            <span className="project-desc">A content-driven platform providing the latest news, club updates, and announcements with an intuitive layout and fast-loading performance.</span>
            <span className="project-tag">Content</span>
          </div>
          <div className="project-item reveal">
            <span className="project-num">07</span>
            <span className="project-title">QADAM</span>
            <span className="project-desc">Article reading platform where all content is dynamically managed through an admin panel, enabling real-time updates and content moderation.</span>
      ...
      <section id="contact">
        <div>
          ...
          <h2 className="contact-big reveal reveal-delay-1">
            Let's<br /><span className="stroke">Work</span><br />Together
          </h2>
        </div>
      ...
      {/* FOOTER */}
      <footer>
        <span className="footer-copy">&copy; 2025 Yash Patel. All rights reserved.</span>
        <span className="footer-built">Crafted with <span>&hearts;</span> in Ahmedabad</span>
      </footer>
    </>
  );
}
